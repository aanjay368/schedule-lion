...
type CreateShiftRequest struct {
	...
	StartTime    *datatypes.Time `json:"start_time,omitempty" validate:"required"`
	EndTime      *datatypes.Time `json:"end_time,omitempty" validate:"is_last_flight=IsLastFlight"`
